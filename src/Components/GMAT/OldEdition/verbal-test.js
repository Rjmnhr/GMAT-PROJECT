...
const VerbalTestPage = () => {
  ...
  const [totalQuestions] = useState(32);
  ...
  const saveUserActivity = (
    ...
    formData.append("verbal_time_spent", newTotalTimeSpent);
    formData.append("practice_exam", storedPracticeExam);
    formData.append("verbal_questions_correct", rightAnswer);
    formData.append("verbal_questions_incorrect", wrongAnswer);
    formData.append("verbal_scaled_score", convertedScore);
