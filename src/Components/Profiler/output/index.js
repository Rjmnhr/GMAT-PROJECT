...
import PreferenceAndGoalsPage from "../input-forms/prefrenence-and-goals";
import ApplicationStrategyPage from "../input-forms/application-strategy";
import { OutputStyled } from "./style";
import AdmissionTips from "./tips";
import AxiosInstance from "../../../Config/axios";
import SelectionOutput from "./selection-output";
              ...
              {sideBarTabs.map((tab, index) => {
                return (
                  <p
                    ...
                    className={` p-3 w-100 m-0 cursor-pointer ${
          ...
          <div className="output-container container pt-3 col-lg-10 col-12">
            {activeIndex === 0 ? (
              <div>
                <div className="mb-5">
                  <h3>
                    <strong>Chances of selection</strong>
                  </h3>
                </div>
