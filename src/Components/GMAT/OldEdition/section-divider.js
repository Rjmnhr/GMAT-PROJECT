...
export const SectionDividerQuant = () => {
  return (
    <>
...
export const SectionDividerVerbal = () => {
  return (
    <div>
      <div className="container p-3 ">
        ...
        <p className="mb-3 text-left fs-4">
          Each of the Critical Reasoning questions is based on a short argument,
          a set of statements, or a plan of action.
        </p>

        <p className="text-left fs-4">
          Each of the Reading Comprehension questions is based on the content of
          a passage. After reading the passage, answer all questions pertaining
          to it on the basis of what is stated or implied in the passage.
        </p>

        <p className="mb-3 text-left fs-4">
          Each of the Sentence Correction questions presents a sentence, part or
          all of which is underlined. Beneath the sentence you will find five
          ways of phrasing the underlined part. The first of these repeats the
          ...
          grammar, word choice, and sentence construction. Select the answer
          that produces the most effective sentence: your answer should make the
      ...
      <>
        <div className="container p-3 ">
          ...
          <p className="mb-3 text-left fs-4 ">
            ...
            require use of both quantitative and verbal skills. Some involve use
            of graphics, tables, or text material. The questions also use
